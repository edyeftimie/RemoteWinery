...
class WinesRepository {
  final List<Wine> _wines = [
    ...
    Wine(20, "Gitana Lupi", "Red", 2003, "Tuscany", "Cabernet Sauvignon, Merlot, Cabernet Franc, natural yeasts", 175, "https://wineful.ro/wp-content/uploads/2017/09/DSCF6465.jpg"),
  ];
  int index = 20;
